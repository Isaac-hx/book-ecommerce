...
const bookCreateFormSchema = z.object({
  title: requiredStr,
...
type FormValues = z.infer<typeof bookCreateFormSchema>;
...
const BookCreateForm = () => {
  ...
  const { mutateAsync: createBook, error } = useCreateBook();
  ...
  const handleFormSubmit = async (formValues: FormValues) => {
    try {
      ...
      const {
        data: { data: url },
      } = await uploadImage(formValues.cover);
      await createBook({ ...formValues, cover_url: url });
